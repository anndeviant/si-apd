...
export default function PengajuanKpi() {
  ...
  const progresOptions = ["Draft", "Approved", "Realisasi", "Hold"];
            ...
            <div className="space-y-4 p-4 max-h-[60vh] overflow-y-auto">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="grid gap-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateField("nomor_project", e.target.value)
                    }
              ...
              <div className="grid gap-2">
                ...
                <DatePickerWithInput
                  ...
                  onChange={(date) =>
                    updateField("tanggal", date || new Date())
                  }
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="grid gap-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateField("jumlah", parseInt(e.target.value) || 0)
                    }
                    placeholder="Jumlah..."
                    disabled={isSubmitting}
                    required
